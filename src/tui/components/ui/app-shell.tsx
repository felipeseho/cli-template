...
const AppShellRoot = ({ children, fullscreen = false }: AppShellProps) => {
  ...
  return (
    <Box
      ...
      flexGrow={1}
      height={fullscreen ? (terminalRows ?? 24) : undefined}
...
const AppShellHints = ({ items, children }: AppShellHintsProps) => {
  ...
  return (
    <Box flexShrink={0} height={1} overflow="hidden" paddingX={1} width="100%">
